 ...
 * @author ronak
 */
public class helloissuedbooks1 extends javax.swing.JFrame {
...
private void customizeComponents() {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(21, 169, 813, 340);
        ...
        jButton1.setBounds(882, 480, 100, 23);
        ...
        jLabel1.setBounds(-3, -44, 1200, 690);
...
private void displayAllIssuedBooks() {
        ...
        try {
            ...
            Logger.getLogger(helloissuedbooks1.class.getName()).log(Level.SEVERE, null, ex);
        }
...
public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new helloissuedbooks1().setVisible(true);
            }
        });
    }
