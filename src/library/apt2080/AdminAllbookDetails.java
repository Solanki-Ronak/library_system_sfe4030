 ...
 * @author ronak
 */
public class AdminAllbookDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtbookname.setBounds(160, 120, 80, 30);
        ...
        txtcoursecode.setBounds(160, 70, 80, 30);

        jLabel12.setIcon(new javax.swing.ImageIcon("C:\\Users\\ronak\\OneDrive\\Desktop\\2.3\\APT2080\\images\\background (1).jpg")); // NOI18N
        jLabel12.setPreferredSize(new java.awt.Dimension(1190, 640));
        getContentPane().add(jLabel12);
        jLabel12.setBounds(10, 0, 1190, 670);
...
private void customizeComponents() {
    ...
    try {
        ...
        Logger.getLogger(AdminAllbookDetails.class.getName()).log(Level.SEVERE, null, ex);
    }
...
public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAllbookDetails().setVisible(true);
            }
        });
    }
