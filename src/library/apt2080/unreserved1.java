 ...
 * @author ronak
 */
public class unreserved1 extends javax.swing.JFrame {
...
private void customizeComponents() {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(39, 49, 110, 30);
        ...
        date1.setBounds(630, 200, 140, 22);
        getContentPane().add(date2);
        date2.setBounds(630, 240, 140, 22);
        ...
        jLabel1.setBounds(-3, -4, 1060, 580);
...
public class ImageTableCellRenderer extends DefaultTableCellRenderer {
 ...
 private void addTableSelectionListener() {
    ...
    try {
        ...
        Logger.getLogger(unreserved1.class.getName()).log(Level.SEVERE, null, ex);
    }
 ...
 String bookName = txtbookname.getText();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         IssueBook1 adminfirstpage=new IssueBook1();
...
public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unreserved1().setVisible(true);
            }
        });
    }
